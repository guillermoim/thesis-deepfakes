...
PYTHONPATH=. CUDA_VISIBLE_DEVICES="1,2,3,4,5,6" python -m torch.distributed.launch --nproc_per_node=6 train.py -s 501 -m efficientnet-b5 --optim_step 2 -batch_size 8 -epoch_size 600 -epochs 30 --ngpu 6 --n_workers 6 -v 0 --amp True --data_path data/train_data > outputs/effnet-b5-501v0.txt
