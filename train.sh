...
PYTHONPATH=. python train_ff.py --seed 501 --model efficientnet-b0 --local_rank 0 --ngpu 0 \
              --batch_size 4 --epoch_size 1 --epochs 3 --n_workers 6 --data_path /Users/guillermo/Desktop/projects/datasets/dfdc/data_ \
              --save_path trained_models --dataset dfdc
