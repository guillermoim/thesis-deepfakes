...
#PYTHONPATH=. CUDA_VISIBLE_DEVICES="1,2,3,4,5,6" python -m torch.distributed.launch --nproc_per_node=6 train.py -s 333 -m efficientnet-b3 -batch_size 32 -epoch_size 1000 -epochs 30 -path_to_model models/effnetb3_v2_1024.pth --ngpu 6 --n_workers 6 -v 0 --amp True> outputs/b.txt
