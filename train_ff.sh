...
#EfficientNet-B5
PYTHONPATH=. CUDA_VISIBLE_DEVICES="1,2,3,4,5,6" python -m torch.distributed.launch --nproc_per_node=6 train_ff.py --ngpu 6 --model efficientnet-b5 --batch_size 6 --distributed --n_workers 6 > outputs/effnetb5_tum_101_v0_fullDA.txt
PYTHONPATH=. CUDA_VISIBLE_DEVICES="1,2,3,4,5,6" python -m torch.distributed.launch --nproc_per_node=6 train_ff.py --ngpu 6 --model efficientnet-b5 --batch_size 6 --data_augment no_da --distributed --n_workers 6 > outputs/effnetb5_tum_101_v0_noDA.txt
PYTHONPATH=. CUDA_VISIBLE_DEVICES="1,2,3,4,5,6" python -m torch.distributed.launch --nproc_per_node=6 train_ff.py --ngpu 6 --model efficientnet-b5 --batch_size 6 --data_augment simple_da --distributed --n_workers 6 > outputs/effnetb5_tum_101_v0_simpleDA.txt
PYTHONPATH=. CUDA_VISIBLE_DEVICES="1,2,3,4,5,6" python -m torch.distributed.launch --nproc_per_node=6 train_ff.py --ngpu 6 --model efficientnet-b5 --batch_size 6 --data_augment occlusions_da --distributed --n_workers 6 > outputs/effnetb5_tum_101_v0_occDA.txt
